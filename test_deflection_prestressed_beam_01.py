...
'''Try 1: I set initial stress in prestressing steel = 4500 kN/m2.
results OK! -> uz=40 mm & N=4500 kN
'''
...
#TENDON
#Material
prestressingSteel= tm.defCableMaterial(preprocessor=prep, name="prestressingSteel",E=Ep,prestress=fps,rho=0.0)
