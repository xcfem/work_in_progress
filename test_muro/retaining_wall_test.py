...
#Geometry
zTopWall= 19.642 # z coordinate of the wall top.
zTopFooting= 9.25 # z coordinate of the footing upper surface.
...
bHeel= 6.6-stemBottomWidth # width of the heel.
footingThickness= 1.85 # thickness of the footing.
cover= 35e-3 # rebars cover.
